...
An example of the setup is shown below. HLJT Animation
...
The versions provided in this repository allow flexibility in terms of key experiment parameters of the MBRT (e.g. **angles of rotation**, **body views**, **limbs**, **types of response**, **trial-to-trial feedback**, **number of repetitions**, etc). The optimal protocol is at the user's discretion, but sensible defaults have been implemented.
