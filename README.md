...
The MBRT is a behavioural paradigm aiming to assess the ability to manipulate movement imagery. If you are interested in assessing Movement Imagery ability, visit the [Movement Imagery Ability Task Platform](https://movementimageryability.github.io) for an overview of open-source behavioural tasks.
...
Please consult the accompanying manuscript ([Czilczer et al., 2026](https://osf.io/preprints/psyarxiv/9xjfb_v1)) on the [Movement Imagery Ability Task Platform](https://movementimageryability.github.io) for a guide on necessary steps to run a task in each of the four deployment modes, which can help with the decision.
